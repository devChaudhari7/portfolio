...
export const projects: Project[] = [
  ...
  },
  {
    ...
    index: "04",
    name: "CheatBot",
    tagline: "Conversational image recognition.",
    year: "2024",
    frame: "browser",
    lead: false,
    stack: ["TensorFlow", "PyTorch", "FastAPI", "Docker", "AWS"],
    bullets: [
      "A Smart India Hackathon 2024 project built for Bharat Electronics Limited (SIH1604), combining computer vision and NLP for real-time object recognition and contextual dialogue.",
      "An ML pipeline (TensorFlow, PyTorch, Scikit-learn) for deep-learning image analysis.",
      "A Dockerized full-stack system — FastAPI + Node.js backend, Next.js frontend, MongoDB, Redis, Kafka — deployed on AWS.",
      "Real-time visual conversation: point at an object, talk about it.",
    ],
    why: "A government-backed national hackathon problem, solved as a real system.",
    flow: [
      { label: "Vision", note: "TF · PyTorch" },
      { label: "NLP dialogue", note: "contextual" },
      { label: "Kafka / Redis", note: "streaming" },
      { label: "AWS", note: "dockerized" },
    ],
    skills: ["tensorflow", "pytorch", "scikit-learn", "computer-vision", "nlp", "fastapi", "nodejs", "mongodb", "redis", "kafka", "docker", "aws"],
    links: {},
    rating: 0.88,
  },
  {
  ...
  },
  {
    id: "android-app",
    index: "06",
    name: "Android Auth & Profile",
    tagline: "Native registration, login & profile.",
    year: "2023",
    frame: "phone",
    lead: false,
    stack: ["Android", "Java"],
    bullets: [
      "A native Android app with user registration and login, client-side input validation, gender selection, and native date-picker integration.",
      "An editable user-profile screen with maintainable, reviewed modules.",
    ],
    why: "Clean fundamentals: validation, native pickers, and a tidy profile flow.",
    flow: [
      { label: "Register / Login", note: "validation" },
      { label: "Profile", note: "editable" },
    ],
    skills: ["java"],
    links: {},
    rating: 0.8,
    flagged: "Add a repo / APK link to finish this card.",
  },
];
